...
public class BankProject2 {
    ...
    public static ArrayList<Client> loadClientsDataFromFile() {
        ...
        try {
            ...
            // file will be created when adding clients
        }
    ...
    public static boolean clientExistsByAccountNumber(String accountNumber) {
    ...
    public static void printClientRecordBalanceLine(Client client) {
        System.out.printf("| %-15s", client.accountNumber);
        System.out.printf("| %-40s", client.name);
        System.out.printf("| %-12.2f", client.accountBalance);
    }
    ...
    public static boolean depositBalanceToClientByAccountNumber(
            String accountNumber, double amount, ArrayList<Client> clients, Scanner scan) {
    ...
    public static void showDepositScreen(Scanner scan) {
        System.out.println("\n-----------------------------------");
        ...
        while (client == null) {
            ...
            accountNumber = readClientAccountNumber(scan);
            client = findClientByAccountNumber(accountNumber, clients);
        }
        ...
        depositBalanceToClientByAccountNumber(accountNumber, amount, clients, scan);
    }

    public static void showWithdrawScreen(Scanner scan) {
        System.out.println("\n-----------------------------------");
        ...
        while (amount > client.accountBalance) {
            ...
            System.out.print("Please enter another amount? ");
            amount = Double.parseDouble(scan.nextLine());
        }

        depositBalanceToClientByAccountNumber(accountNumber, amount * -1, clients, scan);
    }
    ...
    public static void goBackToTransactionsMenu(Scanner scan) {
        System.out.print("\nPress Enter to go back to Transactions Menu...");
        scan.nextLine();
    }

    public static int readTransactionsMenuOption(Scanner scan) {
        System.out.print("Choose what do you want to do? [1 to 4]? ");
        return Integer.parseInt(scan.nextLine());
    }

    public static int readMainMenuOption(Scanner scan) {
        System.out.print("Choose what do you want to do? [1 to 7]? ");
        return Integer.parseInt(scan.nextLine());
    }

    public static void performTransactionsMenuOption(int choice, Scanner scan) {
        switch (choice) {
            case 1:
                showDepositScreen(scan);
                goBackToTransactionsMenu(scan);
                break;

            case 2:
                showWithdrawScreen(scan);
                goBackToTransactionsMenu(scan);
                break;
    ...
    public static void showTransactionsMenu(Scanner scan) {
        int choice;

        do {
            System.out.println("\n===========================================");
            System.out.println("\t\tTransactions Menu Screen");
            System.out.println("===========================================");
            ...
            choice = readTransactionsMenuOption(scan);
            performTransactionsMenuOption(choice, scan);
